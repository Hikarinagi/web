<script setup lang="ts">
  import { Flex, Heading, Inline, Stack, Text } from '@hina-ui/vue'
...
<template>
  <Stack as="section" gap="none" class="relative overflow-hidden border-b border-line">
    ...
    <Flex
      ...
      justify="center"
      gap="none"
      class="relative z-10 box-content min-h-[calc(360px+var(--app-header-height))] px-6 pt-[calc(var(--app-header-height)+48px)] pb-16"
    >
      <Flex
        direction="col"
        gap="none"
        class="mx-auto w-full max-w-app gap-12 lg:flex-row lg:items-center lg:gap-16"
      >
        <Stack gap="none" align="start" class="max-w-xl flex-1 gap-5">
          ...
          <Inline gap="md" align="center">
            <Button :as="NuxtLink" to="/developers/guide">查看文档</Button>
            <Button
              login-required
              variant="outline"
              tone="neutral"
