<script setup lang="ts">
  import { Grid, Heading, Inline, Stack, Text } from '@hina-ui/vue'
...
<template>
  ...
  >
    <Stack
      gap="none"
      class="px-6 pt-[calc(var(--app-header-height)+1.5rem)] pb-7 md:pt-[calc(var(--app-header-height)+2rem)] md:pb-8"
    >
      <Grid :cols="1" class="mx-auto w-full max-w-app">
          ...
          >
            ...
            <Stack gap="none" class="min-w-0 py-1 md:py-2">
              ...
              <Inline align="center" gap="sm" class="mt-4 md:mt-5">
                <Button login-required v-if="startVolume" as-child>
