<script setup lang="ts">
  ...
  defineOptions({ name: 'LightNovelMentions' })
  defineProps<{ posts: LightNovelPageData['posts'] }>()
</script>
    ...
    <div class="flex flex-col">
      ...
      >
        <div class="flex items-center gap-2 text-[13px]">
          ...
          <UserName :user="p.creator" class="font-medium text-surface-700 dark:text-surface-200" />
