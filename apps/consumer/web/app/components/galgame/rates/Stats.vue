<script setup lang="ts">
  ...
  import type { GalgameRateKeyword, GalgameRateStats } from '~/features/galgame/rate'
...
<template>
  ...
  >
    ...
    <div class="flex flex-col gap-8 lg:flex-row lg:items-start">
      ...
      <GalgameRatesStatsProgress :counts="stats.status_counts" :played="stats.played_count" />
    </div>
