<script setup lang="ts">
  ...
  import type { TagFilterGroup, TagFilterOp, TagMatchMode } from '~/features/galgame/explore'
  import { BROWSE_FILTER_KEY } from '~/features/galgame/useBrowseFilter'

  defineOptions({ name: 'GalgameBrowseTagFilterGroup' })
...
<style scoped>
  /* 选中态下不再触发外层卡片的 ripple(PrimeVue 运行时注入的 ink),内部 SelectButton 的 ripple 不受影响 */
