<script setup lang="ts">
  ...
  import type { GalgameBrowseState, TagFilterGroup } from '~/features/galgame/explore'
  import { BROWSE_FILTER_KEY } from '~/features/galgame/useBrowseFilter'

  defineOptions({ name: 'GalgameBrowseTagFilterPopover' })
